...
export function getWinningBoardScore(input) {
    return generator(input).next().value;
}
export function getLosingBoardScore(input) {
    let lastScore = 0;
...
export const partOne = (input) => getWinningBoardScore(input);
export const partTwo = (input) => getLosingBoardScore(input);
